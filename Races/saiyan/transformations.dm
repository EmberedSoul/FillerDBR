	...
	saiyan
		...
		super_saiyan
			...
			class_boons(mob/user)
				var/list/ascs = user.race?.ascensions
				...
				if(user.Class == "Zeal")
					...
					strengthadd = 0.3
					forceadd = 0.3
				if(user.Class == "Pride")//user.race.ascensions[1].choiceSelected == /ascension/sub_ascension/saiyan/pride)
				...
				if(user.Class == "Honor")//user.race.ascensions[1].choiceSelected == /ascension/sub_ascension/saiyan/honor)
					...
					strengthadd = 0.3
					forceadd = 0.3
				if(user.Class == "Savage")
					class_passives = list("AngerAdaptiveForce" = 1, "Juggernaut" = 2, "Defiance" = 1, "Adrenaline" = 1)
					speedadd = 0.25
					enduranceadd = 0.5
					offenseadd = 0.3
					defenseadd = 0.4
				...
				if(user.race.ascensions[1].choiceSelected == istype(choice, /ascension/sub_ascension/half_saiyan/adaptive))
					...
					strengthadd = 0.3
					forceadd = 0.3
				if(user.race.ascensions[1].choiceSelected == istype(choice, /ascension/sub_ascension/half_saiyan/dominating))
		...
		super_saiyan_3
			...
			class_boons(mob/user)
				...
				if(user.Class == "Pride")
					...
					forceadd = 0.5
				if(user.Class == "Savage")
					class_passives = list("AngerAdaptiveForce" = 2, "Juggernaut" = 3, "Defiance" = 2, "Adrenaline" = 2)
					speedadd = 0.4
					enduranceadd = 0.75
					offenseadd = 0.5
					defenseadd = 0.6
